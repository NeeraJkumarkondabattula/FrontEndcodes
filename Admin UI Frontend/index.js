...
for(let i=0;i<data.length;i++){
    ...
    document.querySelector("#role"+i).innerHTML=data[i].role;
}
...
if(input==data[i].name || input==data[i].email || input==data[i].role){
    document.querySelector("#input-box").value= "true";
}else{
    document.querySelector("#input-box").value= "false";
}
